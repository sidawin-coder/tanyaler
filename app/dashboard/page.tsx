          ...
          <div className="flex items-center gap-3">
            ...
            >
              <svg className="w-3 h-3" viewBox="0 0 16 16" fill="currentColor">
                ...
                <text x="8" y="12" textAnchor="middle" fontSize="9" fontWeight="bold" fill="currentColor">S</text>
              </svg>
              {totalCredits} kredit
            </Link>
      ...
      <main className="max-w-6xl mx-auto px-5 md:px-8 py-10 md:py-14">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-slate-600">
            Sedia untuk belajar ePerolehan hari ini?
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-10">
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-6">
            ...
            <div className="text-sm text-slate-500">
              daripada {credits?.dailyFreeLimit ?? 8} soalan
            </div>
            {/* Progress bar */}
            <div className="mt-3 h-1.5 bg-slate-100 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${((credits?.freeRemaining ?? 0) / (credits?.dailyFreeLimit ?? 8)) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="w-8 h-8 bg-amber-100 rounded-xl flex items-center justify-center">
                <svg className="w-4 h-4 text-amber-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 md:p-12 mb-8 text-white relative overflow-hidden">
          ...
          <div className="absolute right-32 bottom-8 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl" />
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-3 tracking-tight">
              Apa soalan ePerolehan
              <br />
              anda hari ini?
            </h2>
            <p className="text-slate-300 text-lg mb-8 max-w-xl">
              Tanya dalam bahasa yang selesa. Saya akan berikan jawapan
        ...
        {/* Upgrade prompt kalau free user */}
        {credits?.plan === 'free' && (
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/60 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-slate-600 text-[15px]">
                Plan Pro RM59/bulan bagi anda 600 kredit soalan. Sesuai untuk
                pengguna aktif.
              </p>
            </div>
            <Link
              href="/pricing"
              className="flex-shrink-0 inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-6 py-3 rounded-full transition-colors shadow-md hover:shadow-lg"
            >
              Lihat Plan Pro
